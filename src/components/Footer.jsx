...
const Footer = () => {
  return (
    <div className="h-[85vh] w-[100vw] bg-[#131313] lg:px-20 px-4 ">
      ...
      <div className="lower  flex flex-col justify-center items-start lg:items-end lg:mt-16 mt-32 gap-2 pb-5">
